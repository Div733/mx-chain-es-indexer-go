...
{"script":{"lang":"painless","params":{"attributes":"YWFhYQ==","metadata":"","tags":null},"source":"if (ctx._source.containsKey('data')) { if (params.metadata != null \u0026\u0026 params.metadata != '') { ctx._source.data.metadata = params.metadata; } else { ctx._source.data.remove('metadata'); } if (params.tags != null) { ctx._source.data.tags = params.tags; } else { ctx._source.data.remove('tags'); } ctx._source.data.attributes = params.attributes; }"},"upsert":{}}
